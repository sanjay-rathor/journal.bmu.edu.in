        ...
        <div className="auth-wrapper App">
            <div className="auth-inner">
                <div className="cover row margin-zero ">
                    ...
                    <div className="col-md-12 cover-imag ">
                ...
                <div className="row margin-zero custom-top-margin" >
                    <div className="col-md-12">
                        ...
                        <Nav variant="pills" className="body-container" defaultActiveKey={currentRoute} >
                            <Nav.Item>
                            ...
                            <Nav.Item>
                                <Nav.Link eventKey="/aim-and-scope" href="/aim-and-scope" className="nav-link-tab">
                                    Aims and Scope
                            </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link eventKey="/editorial-board" href="/editorial-board" className="nav-link-tab">
                                    Editorial Board
                            </Nav.Link>
                            </Nav.Item>
                            {/* <Nav.Item>
                            ...
                            <NavDropdown title="Browse Journal" id="nav-dropdown" className="dropdown-nav-link">
                                <NavDropdown.Item  className="nav-link-tab" eventKey="/browse-journal"   href="/browse-journal">Vol. 1 Issue 1 (April 2021)</NavDropdown.Item>
                                <NavDropdown.Item  className="nav-link-tab"  eventKey="/browse-journal-issue-2"  href="/browse-journal-issue-2" >Vol. 1 Issue 2 (October 2021)</NavDropdown.Item>
                                <NavDropdown.Item  className="nav-link-tab"  eventKey="/browse-journal-vol-2-issue-1"  href="/browse-journal-vol-2-issue-1" >Vol. 2 Issue 1 (April 2022)</NavDropdown.Item>
                                <NavDropdown.Item  className="nav-link-tab"  eventKey="/browse-journal-vol-2-issue-2"  href="/browse-journal-vol-2-issue-2" >Vol. 2 Issue 2 (October 2022) </NavDropdown.Item>
                                
                            </NavDropdown>
                            <Nav.Item>
                                <Nav.Link eventKey="/submission-guidelines" href="/submission-guidelines" className="nav-link-tab">
                                Submission Guidelines
                            </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link eventKey="/responsibilties-of-authors" href="/responsibilties-of-authors" className="nav-link-tab">
                                    Responsibilities of Authors
                            </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link eventKey="/right-and-permissions" href="/right-and-permissions" className="nav-link-tab">
