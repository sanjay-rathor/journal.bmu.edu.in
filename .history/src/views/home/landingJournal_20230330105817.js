                    ...
                    <div className="col-md-9 col-sm-12 body-container ">
                        ...
                        <div className="row " >
                            ...
                            {latestArticles.map((article) => {
                                return <div className="col-md-12 content-text" >
                                    <Card style={{
                                        "width" : "100%"
                                    }}>
                                        <Card.Body>
                                            <Badge variant="primary">{article.type}</Badge>
                                            <Card.Title><a href={"/browse-journal-vol-2-issue-2#"+article.title}>{article.title}</a>  
                                            </Card.Title>
                                            <Card.Text>
                                             {article.author.name}
                                        </Card.Text>
                        ...
                        <div className="row" >
                            <div className="col-md-4 twitter-timeline" >
                                <a className="twitter-timeline" data-height="600" href="https://twitter.com/BMLUniv?ref_src=twsrc%5Etfw">Tweets by BMLUniv</a> <script async src="https://platform.twitter.com/widgets.js" charSet="utf-8"></script>
                            </div>
                            <div className="col-md-8 twitter-timeline">
                                <div className="row">
                                    <div className="col-md-12 ">
                                        <span className="content-tab-title" >International Advisory Board</span>
                                    </div>
                                    <div className="col-md-12 ">
                                        <div className="list-group editor-acordian">
                                            {InternaionalEditors.map(function (item, index) {
                                                return <div className="list-group-item flex-column align-items-start ">
                                                    ...
                                                    <p className="mb-1 editor-about" style={{"text-transform": "lowercase"}}>
                                                         {item.email}
                                                    </p>
