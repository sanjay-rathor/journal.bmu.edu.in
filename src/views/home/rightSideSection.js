                        ...
                        <div className="side-layer">
                            <div className="row content-space-around">
                                <div className="col-md-12 custom-padding">
                                    ...
                                    <a href="journal-files/Special issue-October.pdf" target="_blank">
                                    Call for Papers
                            </a></Badge>
                                </div>
                                <div className="col-md-12 custom-padding">
               ...
               
                   {
                       bookReviews.map((article) => {
                           ...
                           <Card.Body>
                               ...
                               <Card.Title><a href={"/browse-journal#"+article.title}>{article.title}</a></Card.Title>
                               <Card.Text>
                                  {article.author.name}
                       </Card.Text>
                ...
                <div className="col-md-12 custom-padding">
                    <div className="side-tall-img">
                        <div className="side-layer">
                            <div className="row content-space-around">
                                <div className="col-md-12 custom-padding">
                                    <Badge className="side-heading" variant="primary"> Questions?</Badge>
                                </div>
                                <div className="col-md-12">
                                    <Badge   ><a href="mailto:payalk1@gmail.com" className="side-question-tab"> Contact Prof. Dr Payal Kumar </a></Badge>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-md-12 custom-padding">
                    <div className="side-info-img">
                        <div className="side-layer">
                            <div className="row content-space-around">
                                <div className="col-md-12 custom-padding">
                                    <Badge className="side-heading" variant="primary">Important Links</Badge>
                                </div>
                                <div className="col-md-12 custom-padding">
                                    <ListGroup>
                                        <ListGroup.Item><a href="/submission-guidelines#manuscript">Submit Manuscript</a></ListGroup.Item>
                                        <ListGroup.Item><a href="/submission-guidelines">Article Submission</a></ListGroup.Item>
                                    </ListGroup>
                                </div>
                            </div>
                        </div>
