...
import ISSUES_LIST from '../../journals/issue-3/issuesList3.json';
            ...
            <div className="col-md-12">
                <div className="row content-space-around" >
                    <div className="col-md-12 col-sm-12 body-container ">
                        <div className="row">
                            <div className="col-md-5 content-text">
                              
                            </div>
                            <div className="col-md-6 content-text">
                               <h5 className="content-tab-title-issue">Vol. 2 Issue 1</h5>
                            </div>
                        </div>
                        <div className="row ">
                            <div className="col-md-12">
                                <div className="subbody-coming-soon ">
                                    {
                                        ISSUES_LIST.map((article, index) => {
                                            return <div id={article.title} className="col-md-12 content-text" >
                                                <Card style={{
                                                    "width": "100%"
                                                }}>
                                                    <Card.Body>
                                                        ...
                                                        <Card.Title className="title-margin">
                                                            <div className="row">
                                                                ...
                                                                <div className="col-2">
                                                                <a href={article.link} target="_blank"> <span  className="download-btn"> PDF <img style={{
                                                                    "height" : 24
                                                                }} src={PDFICON}></img></span> </a>
                                                                </div>
                                                            </div>
                                                        </Card.Title>
                                                        <Card.Text>
                                                            ...
                                                            <br></br>
                                                                {
                                                                 article.author2.info != null && article.author2.info.map((info) => {
                                                                    return <div>
                                                                        {info}
                                                                        <br></br>
                                                                    </div>
                                                            ...
                                                            <br></br>
                                                                {
                                                                 article.author3.info != null && article.author3.info.map((info) => {
                                                                    return <div>
                                                                        {info}
                                                                        <br></br>
                                                                    </div>
                                                            ...
                                                            {article.abstract != null &&
                                                                ...
                                                                <p className="conceps inline list">
                                                                    {article.keywords != null && <span className="abstract-title separator">Keywords -: </span>}
                                                                    {
                                                                        article.keywords != null && article.keywords.flatMap((keyword, i) => {
                                                                            return <span >
                                                                                {keyword}
